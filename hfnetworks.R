...
getwd()
#setwd("Y:/dguzmancolon/igraph/igraph") #for Zap, pero las columnas no se alinean bien, y los node ID son raros.  
...
Weuc.g<- igraph::graph_from_adjacency_matrix(el.adj,mode="undirected",weighted=TRUE,diag=FALSE)
